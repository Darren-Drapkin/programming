defmodule Game.Board do
  ...
  def newboard do
    [
      ...
      [{"Edge of the forest."}, {"Mr Foleys"} ,{"The Dojo, Hai! Not exactly china"}, {"China, is there a brown loaf here ? "} ],
      [{"Edge of the forest."}, {"Town Hall."} ,{"Deserted Hospital."}, {"Edge of the forest."} ],
      [{"Edge of the forest."}, {"Welcome to the forest, please go north to start your journey to china, for a brown loaf."} ,{"nothing here yet!"}, {"Edge of the forest."} ],
